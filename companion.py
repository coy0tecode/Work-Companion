...
class RegPanel(wx.Panel):
    ...
    # wd changed to image_directory so that hbox4 updates with current
    # companion image
...
class birthdayDialog(wx.Dialog):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Create image holder for bday image (TEMP PIC HERE RIGHT NOW)
...
class BreakPanel(wx.Panel):
    ...
    def breakFunction(self):
        ...
        os.chdir(break_path)
        try:
            # Passing here until I figure out how to run the breaks
...
class MainFrame(wx.Frame):
    ...
    def InitUI(self):
        ...
        self.SetTitle('Work Companion (Alpha)')
        self.Centre()
    ...
    def onAbout(self, e):
        app_info = GMD.GenericMessageDialog(self, 'Version: 0.1\n'
                                            'Author: coy0tecode\n'
                                            'License: MIT License\n'
